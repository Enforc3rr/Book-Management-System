...
public class ViewBooks {
    ...
    public JTextField viewBookSearch;

    public JTable table;
    public void initializeViewBooks() {
        frame = new JFrame();
        ...
        viewBookSearch.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                DAO dao = new DAO();
                try {
                    dao.searchBookTableByName(viewBookSearch.getText(),table);
        ...
        JButton viewBookSearchButton = new JButton("CLICK TO VIEW EVERY BOOK");
        ...
        JLabel viewBookLabel2 = new JLabel("ENTER NAME OF BOOK ->");
